package in.catking.gkapp.quiz.RRB_OA;
...
public class RRB_OA_tfList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbw1APqg0A9pvXj_IkPbK5d1gjaMyaU_6JBuhriuPAJZ4xfrYvA0/exec?MkEmduMsJPUshA85jRGfJXTSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            RRB_OA_tfList.DownloadNews quizTask = new RRB_OA_tfList.DownloadNews();
            quizTask.execute();
        }else{
