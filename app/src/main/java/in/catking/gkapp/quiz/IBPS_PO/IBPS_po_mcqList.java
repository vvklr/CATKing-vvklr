package in.catking.gkapp.quiz.IBPS_PO;
...
public class IBPS_po_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbzN7dqcMBItcbCj41EUjuCUrDpuGFw6bTaynRniumLDciLw1ggC/exec?M60CoSD7GJtaYXpUEIXlf-TSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            IBPS_po_mcqList.DownloadNews quizTask = new IBPS_po_mcqList.DownloadNews();
            quizTask.execute();
        }else{
