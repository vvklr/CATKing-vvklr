...
public class SBI_PO_tfList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbxwt0O483FpzPIonh16IkhVxIs2r8ykc11e_kqGKz2gyWnd1gs/exec?Mnl4XGWcYGa9DkKgLcIxOn7AIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            SBI_PO_tfList.DownloadNews quizTask = new SBI_PO_tfList.DownloadNews();
            quizTask.execute();
        }else{
