package in.catking.gkapp.quiz.RRB_OS;
...
public class RRB_OS_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbyQgEkFQtz1c4KGESwwZg8pGfICHemO43DwzV5doEQd6V74pUDi/exec?MfG0NMb_k1lkBk4d16NR3xzSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            RRB_OS_mcqList.DownloadNews quizTask = new RRB_OS_mcqList.DownloadNews();
            quizTask.execute();
        }else{
