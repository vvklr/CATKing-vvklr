package in.catking.gkapp.quiz.IBPS_Clerk;
...
public class IBPS_c_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbzxSBwxkYfR1kVuab8iWHBfTzR9JqEcN0lVIT5K7cQDNW9-8NjK/exec?Mt7FCy2dFMeqTvBXj0MJZiTSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            IBPS_c_mcqList.DownloadNews quizTask = new IBPS_c_mcqList.DownloadNews();
            quizTask.execute();
        }else{
