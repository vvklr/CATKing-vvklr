package in.catking.gkapp.quiz.XAT;
...
public class XAT_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbyyjJ8qKfzP_t1rs4hNFLYa4-9QkFYsADOPNGjp1Ny1Hq5xhHM/exec?MBQCBN_lM3i75UT6vK5mAQbAIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            XAT_mcqList.DownloadNews quizTask = new XAT_mcqList.DownloadNews();
            quizTask.execute();
        }else{
