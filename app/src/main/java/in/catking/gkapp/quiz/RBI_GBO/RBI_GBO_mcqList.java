package in.catking.gkapp.quiz.RBI_GBO;
...
public class RBI_GBO_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbzwCuA8bnykDwTvluKHEAm_G8pGbA6c6YUnKvBt6N038CsaaI8/exec?MY5WQ62lB-MbpBLuZekf0lLAIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            RBI_GBO_mcqList.DownloadNews quizTask = new RBI_GBO_mcqList.DownloadNews();
            quizTask.execute();
        }else{
