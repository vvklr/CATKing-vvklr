package in.catking.gkapp.quiz.SBI_PO;
...
public class SBI_PO_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbwtlOQS6Tdaq4CMMBQYd67cVxop1xhrf5BoZPm8u-GuArZQTb_m/exec?MQq-YsK_RVJnog5WupRrgGzSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            SBI_PO_mcqList.DownloadNews quizTask = new SBI_PO_mcqList.DownloadNews();
            quizTask.execute();
        }else{
