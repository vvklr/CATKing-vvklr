package in.catking.gkapp.quiz.StaticGK;
...
public class StaticGK_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbxxHUJX9Um8SG7v3KJmBJ_U3_N1bNWRgKEkb-30fYWKdqOHPHg/exec?M_C9fVmI_15le2A4esR-3hrAIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            StaticGK_mcqList.DownloadNews quizTask = new StaticGK_mcqList.DownloadNews();
            quizTask.execute();
        }else{
