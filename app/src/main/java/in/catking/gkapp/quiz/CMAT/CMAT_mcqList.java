package in.catking.gkapp.quiz.CMAT;
...
public class CMAT_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbywzUYWH9VDyNCid6QQs05sSwjfu8-AfZ_Mnuf3-KeGBGYkBVfI/exec?MkyivFuO887V1Zqm41zNEkJCgur5ISDmC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            CMAT_mcqList.DownloadNews quizTask = new CMAT_mcqList.DownloadNews();
            quizTask.execute();
        }else{
