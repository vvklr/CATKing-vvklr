...
public class IBPS_c_tfList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbzSahpUhV-ii4BPmlQWceUuZnGYKg2bC1kEIx9Tc5TVH0IHdrg/exec?Mfw0pof5Wc7rtSoekh8yH-LAIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            IBPS_c_tfList.DownloadNews quizTask = new IBPS_c_tfList.DownloadNews();
            quizTask.execute();
        }else{
