package in.catking.gkapp.quiz.SNAP;
...
public class SNAP_mcqList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbyGrp3yc4ZVZRrgF8XuoeCevQQUP5IlYKtzco19WyaTAn1Z7Pfc/exec?MF9fMGDUox95t_3ql__Q4vTSAfNTxgSUZ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            SNAP_mcqList.DownloadNews quizTask = new SNAP_mcqList.DownloadNews();
            quizTask.execute();
        }else{
