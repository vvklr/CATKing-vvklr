package in.catking.gkapp.quiz.SBI_Clerk;
...
public class SBI_Clerk_tfList extends AppCompatActivity {
    ...
    String QUIZ_SOURCE = "https://script.google.com/macros/s/AKfycbxx4O308_T15NCKsISRR5UYizKArqxFgVvpike_DQlYOIsL1Iw/exec?McrwLHky3ZRuFVJ47n4usfrAIaA47-59-";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            SBI_Clerk_tfList.DownloadNews quizTask = new SBI_Clerk_tfList.DownloadNews();
            quizTask.execute();
        }else{
