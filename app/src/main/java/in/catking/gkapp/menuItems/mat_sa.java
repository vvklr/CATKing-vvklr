...
import in.catking.gkapp.quiz.MAT.MAT_mcqList;
import in.catking.gkapp.quiz.MAT.MAT_tfList;

public class mat_sa extends AppCompatActivity {
...
//        });
        ...
        TextEXAM.setText("MAT GK");

        AboutExam.setText("About MAT");
...
//    public void startTF(){
//        Intent intentC = new Intent(getApplicationContext(), MAT_tfList.class);
//        startActivity(intentC);
//    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), MAT_mcqList.class);
        startActivity(intentD);
    }
    public void startfAboutExam(){
        Intent intentE = new Intent(getApplicationContext(), DetailsActivity.class);
        intentE.putExtra("url","https://catking.in/mat-exam/");
