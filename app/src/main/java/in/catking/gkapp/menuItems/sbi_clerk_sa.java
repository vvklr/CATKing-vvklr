...
import in.catking.gkapp.quiz.SBI_Clerk.SBI_Clerk_mcqList;
import in.catking.gkapp.quiz.SBI_Clerk.SBI_Clerk_tfList;

public class sbi_clerk_sa extends AppCompatActivity {
...
//        rr.removeView(child2);
        ...
        AboutExam.setText("About SBI Clerk");
...
//    public void startTF(){
//        Intent intentC = new Intent(getApplicationContext(), SBI_Clerk_tfList.class);
//        startActivity(intentC);
//    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), SBI_Clerk_mcqList.class);
