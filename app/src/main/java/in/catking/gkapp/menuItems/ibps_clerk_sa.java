...
import in.catking.gkapp.quiz.IBPS_Clerk.IBPS_c_mcqList;
import in.catking.gkapp.quiz.IBPS_Clerk.IBPS_c_tfList;

public class ibps_clerk_sa extends AppCompatActivity {
...
//        rr.removeView(child2);
    ...
    public void startTF(){
        Intent intentC = new Intent(getApplicationContext(), IBPS_c_tfList.class);
        startActivity(intentC);
    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), IBPS_c_mcqList.class);
