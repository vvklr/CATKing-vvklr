...
import in.catking.gkapp.quiz.IBPS_PO.IBPS_po_mcqList;
import in.catking.gkapp.quiz.IBPS_PO.IBPS_po_tfList;

public class ibps_po_sa extends AppCompatActivity {
...
//        rr.removeView(child2);
        AboutExam.setText("About IBPS PO");
...
//    public void startTF(){
//        Intent intentC = new Intent(getApplicationContext(), IBPS_po_tfList.class);
//        startActivity(intentC);
//    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), IBPS_po_mcqList.class);
