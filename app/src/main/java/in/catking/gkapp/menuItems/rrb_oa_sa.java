...
import in.catking.gkapp.quiz.RRB_OA.RRB_OA_mcqList;
import in.catking.gkapp.quiz.RRB_OA.RRB_OA_tfList;

public class rrb_oa_sa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextEXAM.setText("RRB Office Assistant GK");
...
//        rr.removeView(child2);
        ...
        AboutExam.setText("About RRB Office Assistant");
    ...
    public void startTF(){
        Intent intentC = new Intent(getApplicationContext(), RRB_OA_tfList.class);
        startActivity(intentC);
    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), RRB_OA_mcqList.class);
        startActivity(intentD);
    }
    public void startfAboutExam(){
        Intent intentE = new Intent(getApplicationContext(), DetailsActivity.class);
        intentE.putExtra("url","https://catking.in/rrb-exam");
