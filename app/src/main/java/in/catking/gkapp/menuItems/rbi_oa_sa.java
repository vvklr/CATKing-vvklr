...
import in.catking.gkapp.quiz.RBI_OA.RBI_OA_mcqList;
import in.catking.gkapp.quiz.RBI_OA.RBI_OA_tfList;

public class rbi_oa_sa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextEXAM.setText("RBI Office Assistant GK");
...
//        rr.removeView(child2);
        AboutExam.setText("About RBI Office Assistant");
