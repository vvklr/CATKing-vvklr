...
import in.catking.gkapp.quiz.SNAP.SNAP_mcqList;
import in.catking.gkapp.quiz.SNAP.SNAP_tfList;

public class snap_sa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextEXAM.setText("SNAP GK");

        AboutExam.setText("About SNAP");
    ...
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), SNAP_mcqList.class);
        startActivity(intentD);
    }
    public void startfAboutExam(){
        Intent intentE = new Intent(getApplicationContext(), DetailsActivity.class);
        intentE.putExtra("url","https://catking.in/snap/");
