...
import in.catking.gkapp.quiz.SBI_PO.SBI_PO_mcqList;
import in.catking.gkapp.quiz.SBI_PO.SBI_PO_tfList;

public class sbi_po_sa extends AppCompatActivity {
...
//        });
    ...
    public void startTF(){
        Intent intentC = new Intent(getApplicationContext(), SBI_PO_tfList.class);
        startActivity(intentC);
    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), SBI_PO_mcqList.class);
