...
import in.catking.gkapp.quiz.RRB_OS.RRB_OS_mcqList;
import in.catking.gkapp.quiz.RRB_OS.RRB_OS_tfList;

public class rrb_os_sa extends AppCompatActivity {
...
//        });
    ...
    public void startTF(){
        Intent intentC = new Intent(getApplicationContext(), RRB_OS_tfList.class);
        startActivity(intentC);
    }
    public void startMCQ(){
        Intent intentD = new Intent(getApplicationContext(), RRB_OS_mcqList.class);
