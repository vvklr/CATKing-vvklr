...
public class List_view_quiz_selection extends AppCompatActivity {
    ListView listView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.quiz_tems_list);

        listView = (ListView) findViewById(R.id.list_11);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, android.R.id.text2, values);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(view.getContext(), test3.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 1) {
                    Intent myIntent = new Intent(view.getContext(), test4.class);
                    startActivityForResult(myIntent, 0);
                }
...
//
//import in.gkapp.gkapp.view.AnimatedExpandableListView;
//import in.gkapp.gkapp.view.AnimatedExpandableListView.AnimatedExpandableListAdapter;
//
///**
